...
<table cellpadding="0" cellspacing="1" border="0" width="100%" id="ds_custom" style="display:none; margin-top:5px;" align="center">
    <tr>
        <td colspan="2">
            ...
            <div id="custom_sort" style="margin:0 auto; height:152px; border:1px solid #e8e8e8; padding:0 5px; overflow:auto; text-align:center;"></div>
            </fieldset>
        </td>
    </tr>
</table>
...
<script type="text/javascript">
    ...
    dialog.onok = function ()
    {
        ...
        var html = '<input type="text" value="复选按钮组" type1="flow_checkbox" id="' + id + '" name="' + id + '" datasource="' + datasource + '" dictid="' + dictid + '" ';
        if ("1" == datasource)
        {
