...
<script type="text/javascript">
    ...
    function addTableFields(opts, table)
    {
        ...
        $(opts).each(function (index)
        {
            ...
            var tr = '<tr>';
            tr += '<td style="background-color:#ffffff; height:28px;"><input type="checkbox" name="field" value="' + filed + '" id="field_' + filed + '" ' + (isshow ? 'checked="checked"' : '') + ' style="vertical-align:middle;" /><label style="vertical-align:middle;" for="field_' + filed + '">' + filed + '</label></td>';
    ...
    function filedEditSet(field)
    {
        top.mainDialog.open({
            id: "from_set_" + field,
            url: top.rootdir + "/Scripts/FormDesinger/ueditor/plugins/dialogs/subtableset.aspx?eid=set_" + field,
