...
layui.define('view', function(exports){
  ...
  ,admin = {
    ...
    ,theme: function(options){
      ...
      $body.attr('layadmin-themealias', options.color.alias);
        ...
        root.style.setProperty('--tn-nav-color', options.color.selected);
        $(document).find("iframe").each(function () {
            var iframe = $(this);
            var iframeRoot =  iframe.prop('contentWindow').document.querySelector(':root');
            iframeRoot.style.setProperty('--tn-nav-color', options.color.selected);
        });
        layui.data("LuckyuAdminTheme", {
            key: 'color'
            , value: options.color.selected
        }); 
  ...
  //页面跳转
    ...
    , text = othis.attr('lay-text') || othis.text()
    ,router = layui.router();
    luckyu.ajax.postNoloading(luckyu.rootUrl + "/Home/VisitModule",
        { moduleName: text, moduleUrl: href },
        function () {});
