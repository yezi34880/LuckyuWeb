    ...
    var page = {
        ...
        initGridHelpMe: function () {
            var gridHelpMe = $("#gridHelpMe").jqGrid({
                url: luckyu.rootUrl + '/WorkFlowModule/Monitor/GetHelpMePage',
                datatype: "json",
        ...
        initGridAddUser: function () {
            var gridAddUser = $("#gridAddUser").jqGrid({
                url: luckyu.rootUrl + '/WorkFlowModule/Monitor/GetAddUserPage',
                datatype: "json",
                postData: { instanceId: instanceId },
                colModel: [
        ...
        initGridHistory: function () {
            ...
            window.deleteHistory = function (history_id) {
                luckyu.layer.layerConfirm("确定删除该审批记录吗 ？", function () {
                    luckyu.ajax.postv2(luckyu.rootUrl + '/WorkflowModule/Monitor/DeleteHistory', { historyId: history_id }, function (data) {
                        layui.notice.success("操作成功");
        ...
        initData: function () {
            luckyu.ajax.getv2(luckyu.rootUrl + '/WorkflowModule/Monitor/GetTaskScheme', { instanceId: instanceId }, function (data) {
