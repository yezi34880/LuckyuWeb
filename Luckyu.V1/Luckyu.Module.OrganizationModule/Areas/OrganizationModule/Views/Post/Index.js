    ...
    var page = {
        ...
        initGrid: function () {
            grid = grid.LuckyuGrid({
                url: luckyu.rootUrl + "/OrganizationModule/Post/Page",
                datatype: "json",
                altRows: true,//隔行换色
                postData: {},
                colModel: [
                    { name: 'post_id', hidden: true, key: true },
                    { name: 'postcode', label: "岗位编码", width: 60, },
                    { name: 'postname', label: "岗位名称", width: 120, },
        ...
        initBtn: function () {
            ...
            $("#delete").click(function () {
                ...
                luckyu.layer.layerConfirm('确定要删除该数据吗？', function (con) {
                    luckyu.ajax.postv2(luckyu.rootUrl + "/OrganizationModule/Post/DeleteForm", { keyValue: rowid }, function (data, info) {
            ...
            $("#setuser").click(function () {
                ...
                luckyu.ajax.get(luckyu.rootUrl + "/OrganizationModule/UserRelation/GetUsers", { relationType: 2, objectId: rowid },
                    function (res) {
